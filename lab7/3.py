...
mickey_surf = pygame.image.load("images\clock.png") #doing the mickey surface 
lh_surf = pygame.image.load("images\sec_hand.png").convert_alpha() #left hand image 
rh_surf = pygame.image.load("images\min_hand.png").convert_alpha() #right hand image 
...
while 1:
    ...
    rh_surf1=pygame.transform.scale(rh_surf1,(rh_surf1.get_width()//2 ,rh_surf1.get_height()//2.5))
    lh_surf1=pygame.transform.scale(lh_surf1,(lh_surf1.get_width()//2 , lh_surf1.get_height()//2.5))
